...
def load_datasets():
    ...
    old_data_path = RAW_DIR / "Base.csv"  # Changed from Base_old.csv
...
def generate_merge_report(df_new, df_old, df_merged):
    ...
    if 'fraud_bool' in df_merged.columns:
        # Remove data_source before counting
...
def save_merged_data(df_merged):
    """Save merged data (will be validated by validate_data.py)."""
    output_dir = RAW_DIR
...
def save_report(report):
    ...
    report_path = ARTIFACTS_DIR / "merge_report.json"
