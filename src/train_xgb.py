...
def evaluate_model(y_test, y_test_pred, y_test_prob, train_time, prediction_time, fixed_fpr=FIXED_FPR):
    # ROC curve
...
def save_model(model, fixed_threshold, fixed_fpr, metadata):
    ...
    model_path = models_dir / "rf_model_bundle.pkl"
...
def save_training_report(results_default, results_fixed, report_default, report_fixed, metadata):
...
def main():
    ...
    results_default, results_fixed, fixed_threshold, report_default, report_fixed = evaluate_model(
        y_test, y_test_pred, y_test_prob, train_time, prediction_time, FIXED_FPR
    )

    # Save model bundle
    save_model(model, fixed_threshold, FIXED_FPR, metadata)

    # Save training report
    save_training_report(results_default, results_fixed, report_default, report_fixed, metadata)
